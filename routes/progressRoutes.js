...
router.put( "/update-progress", auth, updateCourseProgress);
...
router.get( "/last-lecture/:courseId", auth, getLastWatchedLecture);

// Get next lecture
router.get( "/next-lecture/:courseId", auth, getNextLecture);

// Learning dashboard statistics
router.get( "/stats/:courseId", auth, getLearningStatistics);
